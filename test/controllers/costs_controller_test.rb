...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { cost_amount: @cost.cost_amount, date: @cost.date, name: @cost.name, type: @cost.type }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { cost_amount: @cost.cost_amount, date: @cost.date, name: @cost.name, type: @cost.type }
    assert_redirected_to cost_path(assigns(:cost))
  end
